...
In this tutorial you learn the basic concepts of the PHP language and its commonly used terminology. It's assumed the reader has little to no knowledge of PHP or any other programming languages. If you're just starting out with programming this tutorial can help you with preventing errors, or finding in depth information about PHP more quickly.
