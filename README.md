...
Another trick is by adding a backslash before the quotes `\"`. We call this "escaping" a quote. Escaping characters can only be done in double quoted strings. The following displays `This "is" fine` without the backslashes and no errors.
